            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Robert Marr loves to hear from readers. You can reach him via email. 
                    ...
                    <nav className="social-media-nav">
                        <ul>
                            ...
                            <li>
                                <a href="https://www.facebook.com/Robert-Marr-107159287535533/"
                                target="_blank"
                                rel="noreferrer">
                                    <FontAwesomeIcon   
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/51479860-the-guide-for-understanding-the-end-of-times"
                                    rel="noreferrer"
                                    >
